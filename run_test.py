...
from ARNIQA.data.dataset_clive import LIVEDataset
from data.dataset_spaq import SPAQDataset
from data.dataset_csiq import CSIQDataset  # ✅ CSIQ 데이터셋 추가
from data.dataset_koniq import Koniq10kDataset  # ✅ Koniq-10k 데이터셋 추가
...
if __name__ == "__main__":
    ...
    # ✅ 저장된 체크포인트 로드
    checkpoint_path = Path(args.checkpoint_base_path) / "E:/ARNIQA - SE - mix/ARNIQA/experiments/my_experiment/regressors/epoch_5_srocc_0.926.pth"
    ...
    dataset_paths = {
        ...
        "Koniq-10k": "E:/ARNIQA - SE - mix/ARNIQA/dataset/Koniq-10k"  # ✅ Koniq-10k 추가
    }

    # ✅ 데이터셋 로드
    test_datasets = {
        "KADID10K": KADID10KDataset(root=dataset_paths["KADID10K"], phase="test", crop_size=224),
        "CLIVE": LIVEDataset(root=dataset_paths["CLIVE"], phase="test", crop_size=224),
