...
if __name__ == "__main__":
    ...
    # Train on KADID10K
    kadid_dataset_path = Path(args.data_base_path) / "kadid10k.csv"
    train_dataset = KADID10KDataset(str(kadid_dataset_path))
    ...
    # Test on TID2013
    tid_dataset_path = Path(args.data_base_path) / "tid2013.csv"
    test_dataset = TID2013Dataset(str(tid_dataset_path))
