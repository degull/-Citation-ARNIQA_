...
if __name__ == "__main__":
    ...
    # KADID10K로 훈련
    train_metrics, val_metrics, _ = train(
    args,
    model,
    train_dataloader,
    val_dataloader,
    test_dataloader=test_dataloader,  # None 대신 올바른 DataLoader 전달
    optimizer=optimizer,
...
def test(args, model, test_dataloader, device):
    ...
    return {'srcc': srocc_values, 'plcc': plcc_values}
...
if __name__ == "__main__":
    ...
    print("Test Metrics:")
    if isinstance(test_metrics, dict) and 'srcc' in test_metrics and 'plcc' in test_metrics:
        for i, (srcc, plcc) in enumerate(zip(test_metrics['srcc'], test_metrics['plcc']), 1):
            print(f" - Epoch {i}: SRCC = {srcc:.4f}, PLCC = {plcc:.4f}")
    else:
        print("[Error] Test metrics format is invalid.")
...
from tqdm import tqdm
from sklearn.linear_model import Ridge
from data import TID2013Dataset, LIVEDataset
from models.simclr import SimCLR
from utils.utils import parse_config
from utils.utils_distortions import apply_random_distortions, generate_hard_negatives
import matplotlib.pyplot as plt
...
from tqdm import tqdm
from sklearn.linear_model import Ridge
from data import LIVEDataset, TID2013Dataset
from models.simclr import SimCLR
from utils.utils import parse_config
from utils.utils_distortions import apply_random_distortions, generate_hard_negatives
import matplotlib.pyplot as plt
...
from tqdm import tqdm
from sklearn.linear_model import Ridge
from data import LIVEDataset, CSIQDataset
from models.simclr import SimCLR
from utils.utils import parse_config
from utils.utils_distortions import apply_random_distortions, generate_hard_negatives
import matplotlib.pyplot as plt
...
from tqdm import tqdm
from sklearn.linear_model import Ridge
from data import LIVEDataset, KADID10KDataset
from models.simclr import SimCLR
from utils.utils import parse_config
from utils.utils_distortions import apply_random_distortions, generate_hard_negatives
import matplotlib.pyplot as plt
...
from tqdm import tqdm
from sklearn.linear_model import Ridge
from data import LIVEDataset, SPAQDataset
from models.simclr import SimCLR
from utils.utils import parse_config
from utils.utils_distortions import apply_random_distortions, generate_hard_negatives
import matplotlib.pyplot as plt
...
from tqdm import tqdm
from sklearn.linear_model import Ridge
from data import CSIQDataset, LIVEDataset
from models.simclr import SimCLR
from utils.utils import parse_config
from utils.utils_distortions import apply_random_distortions, generate_hard_negatives
import matplotlib.pyplot as plt
...
if __name__ == "__main__":
    ...
    # 훈련 데이터 분할
    train_size = int(0.8 * len(spaq_dataset))
    val_size = len(spaq_dataset) - train_size
    train_dataset, val_dataset = random_split(spaq_dataset, [train_size, val_size])
